                ...
                foreach (DataRow dr in config.dt.Rows)
                {
                    ...
                    if (config.dt.Rows.Count > 0)
                    {
                        foreach (DataRow dr1 in config.dt.Rows)
                        {
                            ...
                            //ld.prin_amt = !Convert.IsDBNull(dr1["PRIN_AMOUNT"]) ? Convert.ToDecimal(dr1["PRIN_AMOUNT"]) : Convert.ToDecimal(00);
                            //ld.int_amt = !Convert.IsDBNull(dr1["INT_AMOUNT"]) ? Convert.ToDecimal(dr1["INT_AMOUNT"]) : Convert.ToDecimal(00);
                            //ld.int_due = !Convert.IsDBNull(dr1["INT_DUE"]) ? Convert.ToDecimal(dr1["INT_DUE"]) : Convert.ToDecimal(00);                            
                            ...
                            if (config.dt.Rows.Count > 0)
                            {
                                ...
                                {
                                    ld.int_scheme_cd = !Convert.IsDBNull(dr2["INT_SCHEME_CD"]) ? Convert.ToString(dr2["INT_SCHEME_CD"]) : Convert.ToString("");
                                    ld.aint_scheme_cd = !Convert.IsDBNull(dr2["AINT_SCHEME_CD"]) ? Convert.ToString(dr2["AINT_SCHEME_CD"]) : Convert.ToString("");
                                    ld.int_rate_cd = !Convert.IsDBNull(dr2["INT_RATE_CD"]) ? Convert.ToString(dr2["INT_RATE_CD"]) : Convert.ToString("");
                                    ld.aint_scheme_cd = !Convert.IsDBNull(dr2["AINT_RATE_CD"]) ? Convert.ToString(dr2["AINT_RATE_CD"]) : Convert.ToString("");
                                    ld.is_lessint_spcl = !Convert.IsDBNull(dr2["IS_LESSINT_SPCL"]) ? Convert.ToString(dr2["IS_LESSINT_SPCL"]) : Convert.ToString("");
                                    ...
                                    if (config.dt.Rows.Count > 0)
                                    {
                                        ...
                                        {
                                            ld.int_category = !Convert.IsDBNull(dr3["INT_CATEGORY"]) ? Convert.ToString(dr3["INT_CATEGORY"]) : Convert.ToString("");
                                        }
                                    }
                                }
                            }
